document.addEventListener('DOMContentLoaded', function(){
    ...
    formPhones.forEach(formPhone => {
        ...
        const selectElement = formPhone.querySelector('.select');
        const selectFlagImage = formPhone.querySelector('.select img.flag__img');
        const selectCodeInput = formPhone.querySelector('.select .flag__code');
        ...
        function resetOptionsOrder() {
            options.forEach(option => option.style.order = '');
        }
    ...
    window.addEventListener('DOMContentLoaded', moveContentUnder1024px);
